  ...
  const commonCardList = [
    {
      ...
      descriptionEn: (
        <>
          1. Islands, remote villages, and mountainous areas: Replace diesel
          power generation and provide stable electricity; <br />
          2. Microgrid system: Combine with energy storage, solar energy, and
          wind energy to form an independent power supply system
        </>
      ),
    },
    {
      ...
      descriptionEn: (
        <>
          1. Oil palm leaves, coconut shells, rice husks, corn stalks, fruit
          tree branches and other agricultural waste are converted into
          electricity and heat energy through gasification; <br />
          2. Achieve the reduction, resource utilization and harmless treatment
    ...
    },
    {
      ...
      descriptionEn: (
        <>
          1. Small and medium-sized factories, food processing plants, wood
          processing plants, etc.: Provide steam, hot water, and hot air; <br />
          2. Can also directly drive internal combustion engines to generate
          electricity or produce power
        </>
      ),
    },
    {
      ...
      descriptionEn: (
        <>
          1. Resorts, eco-parks, tourist towns: Use local biomass (such as
          coconut shells and branches) for self-sufficiency in energy supply;{" "}
          <br />
          2. Provide electric vehicle charging, lighting, hot and cold water
          systems
        </>
      ),
    },
    {
      ...
      descriptionEn: (
        <>
          1. The gasifier produces biochar, which is used for soil improvement
          and carbon sequestration; <br />
          2. Participate in the international carbon credit trading market to
    ...
    },
    {
      ...
      descriptionEn: (
        <>
          The gasifier+internal combustion engine system can provide power
          generation support for: <br />
          1. Electric tricycles, electric boats, and electric agricultural
          machinery. <br />
          2. Serves as a small mobile energy station
        </>
      ),
    },
  ];
  const applicationCardList = [
    {
      ...
      descriptionEn: (
        <>
          Gasification efficiency 75%, single continuous power generation
          operation up to 500 hours
        </>
      ),
    },
    {
      ...
      descriptionEn: (
        <>
          （Pure dry gas purification ensures clean gas and no secondary
          pollution wastewater, stable power generation）
        </>
      ),
    },
    {
      ...
      descriptionEn: (
        <>
          Single furnace 30~60 tons/day, gasification rate increased to 80%,
          tail waste heat drying raw materials, reducing energy consumption by
          30%
        </>
      ),
    },
